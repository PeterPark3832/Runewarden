...
const _BASE_KO = {
  ...
  shop_reroll:    '🎲 재진열',
  first_run_label: '🔰 처음 플레이하시나요?',
  first_run_btn: '▶ 추천 설정으로 바로 시작',
  first_run_sub: 'Iron Warden · Standard 난이도 · 최적 입문 설정',
  deck_view_title: '현재 덱',
  summary_new_hint: '새 워든 & 난이도 선택',
  summary_retry_btn: '⚡ 동일 조건 재시작',
  summary_retry_hint: '같은 워든 & 난이도',
  summary_hints_title: (n) => `💡 웨이브 ${n} 공략 도움말`,
  log_card_types_hint: '💡 소환(타워 배치) · 강화(타워 업그레이드) · 주문(즉시 발동)',
  shop_key_buy: '구매',
  shop_key_reroll: '재진열',
  shop_key_leave: '나가기',
  shop_add_card:  '🃏 카드 +1',
  ...
  btn_resume:     '▶ 재개',
  btn_how_pause:  '📖 게임 방법',
  pause_reduced_fx: '✨ 화면 흔들림·번쩍임 줄이기',
  ...
  hint_sell_title:   '🔨 타워 철거 & 업그레이드',
  hint_sell_text:    '배치된 타워를 클릭하면 옵션 패널이 열립니다.\n\n• <b>타워 매각</b> — 투자 골드의 50%를 돌려받습니다. 잘못 배치한 타워를 정리하세요.\n• <b>★ 업그레이드</b> — ★2는 플레이어 Lv3, ★3는 Lv6 필요. 업그레이드 비용은 5g(★2) / 12g(★3).',
  ...
  // ── 코덱스 — 적 탭 ───────────────────────────────────
  codex_tab_unlocks:  '해금',
  codex_tab_stats:    '통계',
  codex_tab_enemies:  '적',
  codex_enemy_first_wave: (n) => `첫 등장: ${n}웨이브`,
  codex_enemy_hp:     'HP',
  codex_enemy_spd:    '속도',
  codex_enemy_reward: '골드',
  codex_enemy_trait_camo:        '👁 위장',
  codex_enemy_trait_slow_immune: '🧊 슬로우 면역',
  codex_enemy_trait_enrage:      '⚡ 격노',
  codex_enemy_trait_regen:       '💉 재생',
  codex_enemy_trait_dmg_red:     '🛡 피해 감소',
  codex_enemy_trait_boss:        '💀 보스',
  codex_enemy_trait_elite:       '⚜ 엘리트',
  codex_enemy_trait_shield:      '🔵 실드',
  codex_enemy_trait_split:       '🔀 분열',
  codex_enemy_trait_solar_immune:'☀ 태양 면역',

  codex_enemy_grunt:           '그런트',
  codex_enemy_fast:            '러너',
  codex_enemy_goblin:          '고블린',
  codex_enemy_tank:            '탱크',
  codex_enemy_elite:           '엘리트',
  codex_enemy_shielded:        '실드 병사',
  codex_enemy_berserker:       '광전사',
  codex_enemy_boss:            '철갑 수호자',
  codex_enemy_void_titan:      '공허의 거인',
  codex_enemy_stone_golem:     '스톤 골렘',
  codex_enemy_necromancer:     '네크로맨서',
  codex_enemy_plague_carrier:  '페스트 캐리어',
  codex_enemy_void_wraith:     '공허 유령',
  codex_enemy_void_stalker:    '공허 추적자',
  codex_enemy_juggernaut:      '저거넛',
  codex_enemy_siege_beast:     '공성 야수',
  codex_enemy_phantom:         '팬텀',
  codex_enemy_colossus:        '콜로서스',
  codex_enemy_shadow_elite:    '그림자 엘리트',
  codex_enemy_abyssal_dragon:  '심연의 용',
