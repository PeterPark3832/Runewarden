...
const _BASE_EN = {
  ...
  shop_reroll:    '🎲 Reroll',
  first_run_label: '🔰 First time?',
  first_run_btn: '▶ Quick Start (Recommended)',
  first_run_sub: 'Iron Warden · Standard · Best for beginners',
  deck_view_title: 'Your Deck',
  summary_new_hint: 'New warden & difficulty',
  summary_retry_btn: '⚡ Quick Restart',
  summary_retry_hint: 'Same warden & difficulty',
  summary_hints_title: (n) => `💡 Wave ${n} Tips`,
  log_card_types_hint: '💡 Summon (place tower) · Augment (upgrade tower) · Spell (instant)',
  shop_key_buy: 'Buy',
  shop_key_reroll: 'Reroll',
  shop_key_leave: 'Leave',
  ...
  pause_reduced_fx: '✨ Reduce screen shake & flashes',
  ...
  // ── 코덱스 — 적 탭 ───────────────────────────────────
  codex_tab_unlocks:  'Unlocks',
  codex_tab_stats:    'Stats',
  codex_tab_enemies:  'Enemies',
  codex_enemy_first_wave: (n) => `First: Wave ${n}`,
  codex_enemy_hp:     'HP',
  codex_enemy_spd:    'SPD',
  codex_enemy_reward: 'Gold',
  codex_enemy_trait_camo:        '👁 Camo',
  codex_enemy_trait_slow_immune: '🧊 Slow Immune',
  codex_enemy_trait_enrage:      '⚡ Enrage',
  codex_enemy_trait_regen:       '💉 Regen',
  codex_enemy_trait_dmg_red:     '🛡 Dmg Red.',
  codex_enemy_trait_boss:        '💀 Boss',
  codex_enemy_trait_elite:       '⚜ Elite',
  codex_enemy_trait_shield:      '🔵 Shield',
  codex_enemy_trait_split:       '🔀 Split',
  codex_enemy_trait_solar_immune:'☀ Solar Immune',

  codex_enemy_grunt:           'Grunt',
  codex_enemy_fast:            'Runner',
  codex_enemy_goblin:          'Goblin',
  codex_enemy_tank:            'Tank',
  codex_enemy_elite:           'Elite',
  codex_enemy_shielded:        'Shielded',
  codex_enemy_berserker:       'Berserker',
  codex_enemy_boss:            'Ironclad',
  codex_enemy_void_titan:      'Void Titan',
  codex_enemy_stone_golem:     'Stone Golem',
  codex_enemy_necromancer:     'Necromancer',
  codex_enemy_plague_carrier:  'Plague Carrier',
  codex_enemy_void_wraith:     'Void Wraith',
  codex_enemy_void_stalker:    'Void Stalker',
  codex_enemy_juggernaut:      'Juggernaut',
  codex_enemy_siege_beast:     'Siege Beast',
  codex_enemy_phantom:         'Phantom',
  codex_enemy_colossus:        'Colossus',
  codex_enemy_shadow_elite:    'Shadow Elite',
  codex_enemy_abyssal_dragon:  'Abyssal Dragon',
